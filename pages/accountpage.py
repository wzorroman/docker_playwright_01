...
class AccountPage:
    URL_MAIN = "https://ecommerce-playground.lambdatest.io/"
    ...
    def navigate(self):
        self.page.goto(f"{self.URL_MAIN}index.php?route=account/login")
    
    def new_registration(self):                
        try:
             expect(self.new_registration_link_locator).to_have_attribute("href", f"{self.URL_MAIN}index.php?route=account/register")
    ...
    def forgotten_password(self):                
        try:
            expect(self.forgotten_password_link_locator).to_have_attribute("href", f"{self.URL_MAIN}index.php?route=account/forgotten")    
